...
<div class="hero-section" style="position: relative; background-image: url('../images/mycover.gif'); background-size: cover; background-position: center; height: 70vh;">
        ...
        <div class="search-bar mt-4">
            <form action="buscar.php" method="GET">
                <div class="row g-2">
                    ...
                    <div class="col-md">
                        <button type="button" class="btn btn-primary w-100">Buscar empleos</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="container mt-5">
        ...
        <div class="d-flex flex-wrap gap-2">
            <a href="#" class="btn btn-outline-secondary">desarrollo de software</a>
            <a href="#" class="btn btn-outline-secondary">desarrollo de sofware</a>
            <a href="#" class="btn btn-outline-secondary">informática / telecomunicaciones</a>
        </div>
    </div>
